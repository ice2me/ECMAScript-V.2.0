...
function f7() {
	...
	let out = document.querySelector('.i-7').value;
	let outOne = document.querySelector('.out-71');
	let outTwo = document.querySelector('.out-72');
...
function f8() {
	...
	out.innerHTML = "<input class='i-81'></input><button class='button-primary b-81'>Task-81</button><div class='out-81'></div>";
...
function f9() {
	let inp = document.querySelector('.r-9');
...
function f11() {
	let inpOne = document.querySelector('.i-111').value;
	let inpTwo = document.querySelector('.i-112');
	inpTwo.value = inpOne;
}
...
function f13() {
	let inp = document.querySelector('.i-13').value;
...
function f14() {
	let inp = document.querySelector('.t-14').value;
...
function f16() {
	...
	let sel = document.querySelector('.s-16').value;
...
function f17() {
	let sel = document.querySelector('.s-17').value;
...
function f19() {
	...
	let pas = document.querySelector('.i-192').value;
	let out = document.querySelector('.out-19');
	out.innerHTML = name + ' ' + pas;
}
