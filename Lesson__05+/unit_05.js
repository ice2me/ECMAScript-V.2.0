...
function t8() {
	let inpOne = +document.querySelector('.i-81').value;
	let inpTwo = +document.querySelector('.i-82').value;
...
function t9() {
	let inpOne = +document.querySelector('.i-91').value;
	let inpTwo = +document.querySelector('.i-92').value;
