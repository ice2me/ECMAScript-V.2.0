...
let ar1 = ['one', 56, '1989', 'name', true, false, 30, 'aloha'];
...
let ar2 = ['two', true, '1455', 'yellow', false, 28, 'new', 99];
function f2() {
	let out = '';
...
let ar3 = ['one', 56, true, '1455', 'yellow', true, false, 30, 'aloha'];
function f3() {
	let t = '';
...
let ar4 = ['one', 56, false, 28, 'new', 99, true, '1455', 'yellow', true, false, 30, 'aloha'];
...
function f8() {
	...
	document.querySelector('.out-8-1').innerHTML = t;
}
