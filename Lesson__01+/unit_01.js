...
document.querySelector('.three').innerHTML = '<h3>Free Text Free Text Free Text</h3>';
...
document.querySelector('.four').innerHTML += '<h4>JavaScript</h4>' + '<p>Forever jsjsjsjsjsjsjssjsjsjsjsjs Forever jsjsjsjsjsjsjssjsjsjsjsjs</p>';
...
//Todo document.querySelector('body').innerHTML = '';